...
<div class="modal fade" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$cat->id}}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Você realmente deseja remover a categoria {{$cat->description}}?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                {!!Form::open(['method' => 'GET', 'url' => '/categorias/'.$cat->id.'/destroy', 'style' =>  'display: inline;']) !!}
...
<div class="modal fade" aria-hidden="true" role="dialog" tabindex="-1" id="modal-edit-{{$cat->id}}">
    <div class="modal-dialog" role="document">
        {!!Form::open(['method' => 'put', 'url' => "/categorias/".$cat->id.'/update','style' =>  'display: inline;']) !!}
        <div class="modal-content">
            <div class="modal-header">
